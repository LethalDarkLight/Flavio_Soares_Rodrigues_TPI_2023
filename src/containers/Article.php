...
class Article
{
     ...
     */
    public function __construct($idParam = -1, $nameParam, $descriptionParam, $priceParam, $stockParam, $categoryIdParam, $featuredParam = false, $creationDateParam, $updateDateParam = null)
    {
        $this->id = $idParam;
        $this->name = $nameParam;
